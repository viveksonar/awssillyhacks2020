...
"""
## ALEXA_SKILL_ID = 'amzn1.ask.skill.cef207f5-d3af-4c42-8655-57c2c1d6e993'
...
def build_speechlet_response(title, output, reprompt_text, should_end_session):
    return {
        ...
        'card': {
            'type': 'Simple',
            'title': "Silly CI - " + title,
            'content': "Silly CI - " + output
        },
        'reprompt': {
            'outputSpeech': {
                'type': 'PlainText',
...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Welcome, to Silly CI. I can launch your Jenkins pipeline. Start by saying, deploy my code."
...
def handle_session_end_request():
    ...
    speech_output = "Thank you for using Silly CI. "
...
def lambda_handler(event, context):
    ...
    if (event['session']['application']['applicationId'] !=
            "amzn1.ask.skill.cef207f5-d3af-4c42-8655-57c2c1d6e993"):
